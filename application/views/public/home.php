            ...
            <div class="col-lg-4 col mb-4 w-100">
                <div class="card rounded-0 shadow-sm border-0 post">
                    ...
                    <div class="card-img  post-item px-4 pb-4">
                        <img src="https://images-eu.ssl-images-amazon.com/images/G/31/img20/Wireless/Jupiter20/OnePlus/DesktopGateway_CategoryCard_379X304._SY304_CB418738800_.jpg" class=" post-item-image w-100" alt="">
                    </div>
                </div>
            </div>
        <div class="col-lg-4 col mb-4 w-100">
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-prev prev" style="padding:0px!important; width:70px!important;" href="#carouselExampleIndicators" role="button" data-slide="prev">
    <span class="carousel-control bg-white p-4" aria-hidden="true"><i class="fas fa-chevron-left text-muted fa-2x"></i></span>
    <span class="sr-only">Previous</span>
  </a>
  <a class="carousel-control-next next" style="padding:0px!important; width:70px!important;" href="#carouselExampleIndicators" role="button" data-slide="next">
    <span class="carousel-control bg-white p-4" aria-hidden="true"><i class="fas fa-chevron-right text-muted fa-2x"></i></span>
        ...
        <div class="col-lg-3 col-sm-6 col-6 mb-4">
            <div class="card shadow-sm post border-0">
                ...
                <div class="card-body">
                    ...
                    <h2 class="h6 d-flex mt-3"><del class="small"><sup>₹</sup> <?= $item->price; ?></del> <span class="ml-3 text-danger"><h5>₹ <?= $item->discount_price; ?></h5></span></h2>
                </div>
            </div>
        </div>
        <?php endforeach; ?>
