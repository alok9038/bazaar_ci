...
<div class="container p-0 mt-4 ">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="row">
				<div class="col-lg-4">
					<img src="<?= base_url('assets/upload/'.$product['0']->image); ?>"
						class="w-100 img-fluid border border-muted" alt="">
				</div>
				<div class="col-lg-8">
					<div class="card border-0 ">
						<div class="card-body">
							...
							<a href="<?= base_url('user/addToCart/'.$product['0']->id); ?>" class="btn btn-success rounded-0 mt-4">Add to Cart</a>
