   ...
   <div class="col-lg-9">
       <?php foreach($product as $item): ?>
        ...
        <div class="col-lg-8 p-3">
            <h4 class="text-truncate h5 text-muted"><a href="<?= base_url('home/product/'.$item->id);?>" class="stretched-link post-link" id="post-link"><?= $item->title; ?></a></h4>
            <p class="text-muted mt-n2 small">by <?= $item->brand; ?></p>
            <span class="d-flex"> <h4 class="text-danger">₹ <?= $item->discount_price;?>.00</h4><h6 class="text-dark mt-2 ml-3"> <del>₹ <?= $item->price; ?></del></h6>          
            </span>
